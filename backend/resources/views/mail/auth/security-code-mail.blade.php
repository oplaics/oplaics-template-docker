...
<body>
  <div class="container">
    <div class="header">
      ...
      <div>
        <p class="brand">Sistem Example</p>
    ...
    <div class="body">
      ...
      <p class="message">Has solicitado un código de recuperación de contraseña para acceder a tu cuenta. Ingresa el siguiente código en la aplicación para continuar.</p>
